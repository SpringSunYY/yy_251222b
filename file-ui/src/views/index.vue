  ...
  <div class="app-container">
    ...
    <el-row :gutter="5">
      ...
      <el-col :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <LineSimpleCharts
            :chart-title="downloadStatisticsName"
            :chart-data="downloadStatisticsData"/>
        </div>
      </el-col>
      <el-col :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
...
<script>
import {listFileInfoPublic} from "@/api/manage/fileInfo";
...
export default {
  ...
  methods: {
    ...
    async previewFile(item) {
      this.$modal.msgSuccess("加载文件中");
      //新增浏览记录
      await addViewInfo({fileId: item.id})
      this.$router.push({
        path: '/file-preview',
        query: {
