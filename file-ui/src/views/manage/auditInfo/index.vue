  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="auditInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="类型编号" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="fileTypeId" />
        <el-table-column label="类型名称" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="fileTypeName" />
        <el-table-column label="文件编号" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="fileId" />
        <el-table-column label="文件名称" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="fileName" />
        <el-table-column label="文件类型" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="fileType" />
        <el-table-column label="文件大小" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="fileSize" />
        <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="auditUserId" />
        <el-table-column label="审核内容" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="content" />
        <el-table-column label="是否同意" align="center" v-if="columns[10].visible" prop="isAgree">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.is_agree" :value="scope.row.isAgree"/>
        </template>
      </el-table-column>
        <el-table-column label="审核时间" align="center" v-if="columns[11].visible" prop="auditTime" width="180">
        <template slot-scope="scope">
      ...
      <el-upload ref="upload" :limit="1" accept=".xlsx, .xls" :headers="upload.headers" :action="upload.url + '?updateSupport=' + upload.updateSupport" :disabled="upload.isUploading" :on-progress="handleFileUploadProgress" :on-success="handleFileSuccess" :auto-upload="false" drag>
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的审核信息数据
          </div>
...
<script>
import { listAuditInfo, getAuditInfo, delAuditInfo, addAuditInfo, updateAuditInfo, importAuditInfo, importTemplateAuditInfo } from "@/api/manage/auditInfo";
...
export default {
  ...
  methods: {
    ...
    importTemplate() {
      ...
      }, `auditInfo_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
