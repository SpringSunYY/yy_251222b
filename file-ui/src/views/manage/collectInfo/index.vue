  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collectInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="收藏夹编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="folderId" />
        <el-table-column label="收藏夹" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="folderName" />
        <el-table-column label="类型编号" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="fileTypeId" />
        <el-table-column label="类型名称" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="fileTypeName" />
        <el-table-column label="文件编号" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="fileId" />
        <el-table-column label="文件名称" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="fileName" />
        <el-table-column label="文件类型" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="fileType" />
        <el-table-column label="文件大小" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="fileSize" />
        <el-table-column label="备注" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="remark" />
        <el-table-column label="用户" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="收藏夹编号" prop="folderId">
          <el-input v-model="form.folderId" placeholder="请输入收藏夹编号" />
        </el-form-item>
        <el-form-item label="类型编号" prop="fileTypeId">
      ...
      <el-upload ref="upload" :limit="1" accept=".xlsx, .xls" :headers="upload.headers" :action="upload.url + '?updateSupport=' + upload.updateSupport" :disabled="upload.isUploading" :on-progress="handleFileUploadProgress" :on-success="handleFileSuccess" :auto-upload="false" drag>
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的收藏记录数据
          </div>
...
<script>
import { listCollectInfo, getCollectInfo, delCollectInfo, addCollectInfo, updateCollectInfo, importCollectInfo, importTemplateCollectInfo } from "@/api/manage/collectInfo";
...
export default {
  ...
  methods: {
    ...
    importTemplate() {
      ...
      }, `collectInfo_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
